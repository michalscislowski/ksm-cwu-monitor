...
import { EfficiencyHierarchyPanel } from '@/components/node-detail/EfficiencyHierarchyPanel';
...
export default async function NodeDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="space-y-6 pb-20 md:pb-6">
      ...
      {/* Main indicator: Efficiency Hierarchy */}
      <div className="animate-in stagger-2">
        <EfficiencyHierarchyPanel
          hierarchy={node.efficiency.hierarchy}
          indicators={node.efficiency.indicators}
        />
      </div>

      {/* Secondary row - Forecast + Benchmark */}
